...
class Controlador:
    ...
    def vistaReporte(self):
        if self.rol == 'Administrador':
            ...
            text="Se necesitan credenciales de administrador para acceder a los reportes."
            self.vista.mensaje(text)
